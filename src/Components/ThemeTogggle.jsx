...
function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme} className="fixed top-5.5 right-17 z-50 p-2 rounded-full transition-colors duration-700 ease-in-out focus:outline-hidden hover:scale-110">
      {isdarkmode ? (
